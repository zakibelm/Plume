    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="card p-8">
          <h1 className="text-xl font-semibold text-gray-100 mb-1">Créer un compte</h1>
          <p className="text-sm text-gray-500 mb-6">Rejoignez Plume gratuitement</p>
          ...
          {success ? (
            <div className="text-center py-4">
              ...
              <p className="text-gray-200 font-medium mb-2">Vérifiez votre email</p>
              <p className="text-sm text-gray-500 mb-6">
                Un lien de confirmation a été envoyé à <strong className="text-gray-300">{email}</strong>.
              </p>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button type="submit" disabled={loading}
                  ...
                  {loading ? <><Spinner white />Création…</> : 'Créer mon compte'}
                </button>
              </form>
